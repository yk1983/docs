            ...
            <div className="pagetitle">
                ...
                <nav>
                    <ol className="breadcrumb">
                        ...
                        <li className="breadcrumb-item">React</li>
            ...
            <section className="section">
                <div className="row">
                    <div className="col-lg-12">
                        <div className="card">
                            <div className="card-body">
                                <h5 className="card-title">리액트의 소개</h5>
                                <p>
                                    리액트(React, React.js 또는 ReactJS)는 자바스크립트 라이브러리의 하나로서 사용자 인터페이스를 만들기 위해 사용됩니다.
                    ...
                    <div className="col-lg-6">
                        <div className="card">
                            <div className="card-body">
                                <h5 className="card-title">JSX(JavaScript XML)</h5>
                                <p>
                                    JSX(JavaScript XML)는 XML같은 문법을 사용하는 ECMAScript의 확장입니다.
                    ...
                    <div className="col-lg-6">
                        <div className="card">
                            <div className="card-body">
                                <h5 className="card-title">가상 DOM</h5>
                                <p>
                                    다른 저명한 기능은 가상 문서 객체 모델, 즉 가상 DOM의 사용입니다.
                    ...
                    <div className="col-lg-6">
                        <div className="card">
                            <div className="card-body">
                                <h5 className="card-title">스테이트풀 컴포넌트</h5>
                                <p>
                    ...
                    <div className="col-lg-6">
                        <div className="card">
                            <div className="card-body">
                                <h5 className="card-title">라이프사이클 메서드</h5>
                                <p>
