            ...
            <BsContainer className="section" >
                ...
                >
                    <BsCardText>
                        ...
                        페이스북과 개별 개발자 및 기업들 공동체에 의해 유지보수됩니다.
                        <br />
                ...
                >
                    <DlList>
                        ...
                        <DdItem>
                            ...
                            기존 코드를 다시 작성하지 않고도 리액트의 새로운 기능을 이용해 개발할 수 있습니다.
                        </DdItem>
                    </DlList>
                </BsCard>
                ...
                <BsCard
                    col={ 12 }
                    title="JSX"
                    subtitle="Javascript Syntax eXtension"
                >
                    <BsCardText>
                    ...
                    <DlList>
                        ...
                        <DtItem>
                            React DOM은 HTML 어트리뷰트 이름 대신 camelCase
                            프로퍼티 명명 규칙을 사용
                        </DtItem>
                        <DdItem>
                ...
                >
                    <BsCardText>
                        ...
                        상태는 클래스형 컴포넌트에서만 사용할 수 있습니다.
                        <br />
                        각각의 상태는 독립적이기 때문에 다른 컴포넌트의 직접적인 접근이 불가능 하지만,
                        상위 상태는 상태를 변경해주는 함수를 프로퍼티로 받을 경우 상태의 변경이 가능합니다.
                    </BsCardText>
                </BsCard>
                ...
                >
                    ...
                    <Note
                        variant="info"
                        title="리액트 라이프 사이클(React Life Cycle)을 알아야 하는 이유!"
                        content="* 생명주기를 알고 생명주기에 따라 어떤 작업을 처리해줘야 하는지 지정해줘야 불필요한 리렌더링을 방지할 수 있습니다."
                    />
                </BsCard>
                ...
                >
                    <BsCardText>
                        <span className="text-primary">훅(Hook)</span>은 함수 컴포넌트에서 리액트 상태와 라이프 사이클
                        기능을 연동할 수 있게 해주는 함수입니다.
                        훅은 클래스 안에서는 동작하지 않으며 대신 클래스 없이 리액트를 사용할 수 있게 해주는 것입니다.
                    </BsCardText>
                </BsCard>
            </BsContainer>
        </>
