            ...
            <section className="section">
                <div className="row">
                    ...
                    <div className="col-lg-12">
                        <div className="card">
                            <div className="card-body">
                                <h5 className="card-title">변수명 생성 규칙</h5>
                                <p>
                    ...
                    <div className="col-lg-12">
                        <div className="card">
                            <div className="card-body">
                                <h5 className="card-title">변수의 종류</h5>
                                <ul>
                                    <li>기본형(primitive type) 변수 : 기본형 변수는 실제 연산에 사용되는 변수입니다.
                                        <ul>
                                    ...
                                    <li>참조형(reference type) 변수 : 참조형 변수는 기본형 변수를 제외한 변수 또는 기본형 변수를 사용하여 사용자가 직접 만들어 사용하는 변수를 의미합니다.
                                        <ul>
                                            <li>문자열 : String</li>
                                            <li>배열 : Arrays</li>
                                        </ul>
                    ...
                    <div className="col-lg-12">
                        <div className="card">
                            <div className="card-body">
                                <h5 className="card-title">변수의 선언</h5>
                                <p>
