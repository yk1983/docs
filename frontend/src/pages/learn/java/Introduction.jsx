            ...
            <section className="section">
                <div className="row">
                    ...
                    <div className="col-lg-6">
                        <div className="card">
                            <div className="card-body">
                                <h5 className="card-title">자바의 장점</h5>
                                <ul>
                    ...
                    <div className="col-lg-6">
                        <div className="card">
                            <div className="card-body">
                                <h5 className="card-title">자바의 단점</h5>
                                <ul>
                                    <li>
                    ...
                    <div className="col-lg-6">
                        <div className="card">
                            <div className="card-body">
                                <h5 className="card-title">자바 가상 머신<sup>Java Virtual Machine(JVM)</sup></h5>
                                <p>
                    ...
                    <div className="col-lg-6">
                        <div className="card">
                            <div className="card-body">
                                <h5 className="card-title">가비지 컬렉터<sup>Garbage Collector(GC)</sup></h5>
                                <p>
                    ...
                    <div className="col-lg-4">
                        <div className="card">
                            <div className="card-body">
                                <h5 className="card-title">자바 개발 키트<sup>Java Development Kit(JDK)</sup></h5>
                                <p>
                    ...
                    <div className="col-lg-4">
                        <div className="card">
                            <div className="card-body">
                                <h5 className="card-title">자바 런타임 환경<sup>Java Runtime Environment(JRE)</sup></h5>
                                <p>
                    ...
                    <div className="col-lg-4">
                        <div className="card">
                            <div className="card-body">
                                <h5 className="card-title">소프트웨어 개발 키트<sup>Software Development Kit(SDK)</sup></h5>
                                <p>
